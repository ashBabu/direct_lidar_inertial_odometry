...
lidar_mapping::OdomNode::OdomNode() : Node("lidar_odom_node") {

  this->getParams();

  this->num_threads_ = omp_get_max_threads();

  this->lidar_mapping_initialized = false;
  ...
  this->lidar_sub = this->create_subscription<sensor_msgs::msg::PointCloud2>("pointcloud", qos_settings,
      std::bind(&lidar_mapping::OdomNode::callbackPointCloud, this, std::placeholders::_1), lidar_sub_opt);
  ...
  this->imu_sub = this->create_subscription<sensor_msgs::msg::Imu>("imu", rclcpp::SensorDataQoS(),
      std::bind(&lidar_mapping::OdomNode::callbackImu, this, std::placeholders::_1), imu_sub_opt);
  ...
  this->publish_timer = this->create_wall_timer(std::chrono::duration<double>(0.01), 
      std::bind(&lidar_mapping::OdomNode::publishPose, this));
...
lidar_mapping::OdomNode::~OdomNode() {}

void lidar_mapping::OdomNode::getParams() {

  // Version
  lidar_mapping::declare_param(this, "version", this->version_, "0.0.0");

  // Frames
  lidar_mapping::declare_param(this, "frames/odom", this->odom_frame, "odom");
  lidar_mapping::declare_param(this, "frames/baselink", this->baselink_frame, "base_link");
  lidar_mapping::declare_param(this, "frames/lidar", this->lidar_frame, "lidar");
  lidar_mapping::declare_param(this, "frames/imu", this->imu_frame, "imu");

  // Deskew Flag
  lidar_mapping::declare_param(this, "pointcloud/deskew", this->deskew_, true);

  // Gravity
  lidar_mapping::declare_param(this, "odom/gravity", this->gravity_, 9.80665);

  // Compute time offset between lidar and imu
  lidar_mapping::declare_param(this, "odom/computeTimeOffset", this->time_offset_, false);

  // Keyframe Threshold
  lidar_mapping::declare_param(this, "odom/keyframe/threshD", this->keyframe_thresh_dist_, 0.1);
  lidar_mapping::declare_param(this, "odom/keyframe/threshR", this->keyframe_thresh_rot_, 1.0);

  // Submap
  lidar_mapping::declare_param(this, "odom/submap/keyframe/knn", this->submap_knn_, 10);
  lidar_mapping::declare_param(this, "odom/submap/keyframe/kcv", this->submap_kcv_, 10);
  lidar_mapping::declare_param(this, "odom/submap/keyframe/kcc", this->submap_kcc_, 10);

  // Dense map resolution
  lidar_mapping::declare_param(this, "map/dense/filtered", this->densemap_filtered_, true);

  // Wait until movement to publish map
  lidar_mapping::declare_param(this, "map/waitUntilMove", this->wait_until_move_, false);

  // Crop Box Filter
  lidar_mapping::declare_param(this, "odom/preprocessing/cropBoxFilter/size", this->crop_size_, 1.0);

  // Voxel Grid Filter
  lidar_mapping::declare_param(this, "pointcloud/voxelize", this->vf_use_, true);
  lidar_mapping::declare_param(this, "odom/preprocessing/voxelFilter/res", this->vf_res_, 0.05);

  // Adaptive Parameters
  lidar_mapping::declare_param(this, "adaptive", this->adaptive_params_, true);
  ...
  lidar_mapping::declare_param(this, "extrinsics/baselink2imu/t", baselink2imu_t, t_default);
  lidar_mapping::declare_param(this, "extrinsics/baselink2imu/R", baselink2imu_R, R_default);
  ...
  lidar_mapping::declare_param(this, "extrinsics/baselink2lidar/t", baselink2lidar_t, t_default);
  lidar_mapping::declare_param(this, "extrinsics/baselink2lidar/R", baselink2lidar_R, R_default);
  ...
  // IMU
  lidar_mapping::declare_param(this, "odom/imu/calibration/accel", this->calibrate_accel_, true);
  lidar_mapping::declare_param(this, "odom/imu/calibration/gyro", this->calibrate_gyro_, true);
  lidar_mapping::declare_param(this, "odom/imu/calibration/time", this->imu_calib_time_, 3.0);
  lidar_mapping::declare_param(this, "odom/imu/bufferSize", this->imu_buffer_size_, 2000);
  ...
  lidar_mapping::declare_param(this, "odom/imu/approximateGravity", this->gravity_align_, true);
  lidar_mapping::declare_param(this, "imu/calibration", this->imu_calibrate_, true);
  lidar_mapping::declare_param(this, "imu/intrinsics/accel/bias", prior_accel_bias, accel_default);
  lidar_mapping::declare_param(this, "imu/intrinsics/gyro/bias", prior_gyro_bias, gyro_default);

  // scale-misalignment matrix
  std::vector<double> imu_sm_default{1., 0., 0., 0., 1., 0., 0., 0., 1.};
  std::vector<double> imu_sm;

  lidar_mapping::declare_param(this, "imu/intrinsics/accel/sm", imu_sm, imu_sm_default);
  ...
  // GICP
  lidar_mapping::declare_param(this, "odom/gicp/minNumPoints", this->gicp_min_num_points_, 100);
  lidar_mapping::declare_param(this, "odom/gicp/kCorrespondences", this->gicp_k_correspondences_, 20);
  lidar_mapping::declare_param(this, "odom/gicp/maxCorrespondenceDistance", this->gicp_max_corr_dist_,
      std::sqrt(std::numeric_limits<double>::max()));
  lidar_mapping::declare_param(this, "odom/gicp/maxIterations", this->gicp_max_iter_, 64);
  lidar_mapping::declare_param(this, "odom/gicp/transformationEpsilon", this->gicp_transformation_ep_, 0.0005);
  lidar_mapping::declare_param(this, "odom/gicp/rotationEpsilon", this->gicp_rotation_ep_, 0.0005);
  lidar_mapping::declare_param(this, "odom/gicp/initLambdaFactor", this->gicp_init_lambda_factor_, 1e-9);

  // Geometric Observer
  lidar_mapping::declare_param(this, "odom/geo/Kp", this->geo_Kp_, 1.0);
  lidar_mapping::declare_param(this, "odom/geo/Kv", this->geo_Kv_, 1.0);
  lidar_mapping::declare_param(this, "odom/geo/Kq", this->geo_Kq_, 1.0);
  lidar_mapping::declare_param(this, "odom/geo/Kab", this->geo_Kab_, 1.0);
  lidar_mapping::declare_param(this, "odom/geo/Kgb", this->geo_Kgb_, 1.0);
  lidar_mapping::declare_param(this, "odom/geo/abias_max", this->geo_abias_max_, 1.0);
  lidar_mapping::declare_param(this, "odom/geo/gbias_max", this->geo_gbias_max_, 1.0);
}

void lidar_mapping::OdomNode::start() {

  printf("\033[2J\033[1;1H");
  std::cout << std::endl
            << "+-------------------------------------------------------------------+" << std::endl;
  std::cout << "|               Prometheus Lidar Mapping v" << this->version_  << "               |"
            << std::endl;
  std::cout << "+-------------------------------------------------------------------+" << std::endl;

}

void lidar_mapping::OdomNode::publishPose() {
...
void lidar_mapping::OdomNode::publishToROS(pcl::PointCloud<PointType>::ConstPtr published_cloud, Eigen::Matrix4f T_cloud) {
...
void lidar_mapping::OdomNode::publishCloud(pcl::PointCloud<PointType>::ConstPtr published_cloud, Eigen::Matrix4f T_cloud) {
...
void lidar_mapping::OdomNode::publishKeyframe(std::pair<std::pair<Eigen::Vector3f, Eigen::Quaternionf>, pcl::PointCloud<PointType>::ConstPtr> kf, rclcpp::Time timestamp) {
...
void lidar_mapping::OdomNode::getScanFromROS(const sensor_msgs::msg::PointCloud2::SharedPtr& pc) {
  ...
  this->sensor = lidar_mapping::SensorType::UNKNOWN;
  for (auto &field : pc->fields) {
    if (field.name == "t") {
      this->sensor = lidar_mapping::SensorType::OUSTER;
      break;
    } else if (field.name == "time") {
      this->sensor = lidar_mapping::SensorType::VELODYNE;
      break;
    } else if (field.name == "timestamp" && original_scan_->points[0].timestamp < 1e14) {
      this->sensor = lidar_mapping::SensorType::HESAI;
      break;
    } else if (field.name == "timestamp" && original_scan_->points[0].timestamp > 1e14) {
      this->sensor = lidar_mapping::SensorType::LIVOX;
      break;
    }
  }

  if (this->sensor == lidar_mapping::SensorType::UNKNOWN) {
    this->deskew_ = false;
  }
...
void lidar_mapping::OdomNode::preprocessPoints() {

  // Deskew the original lidar_mapping::-type scan
  if (this->deskew_) {
...
void lidar_mapping::OdomNode::deskewPointcloud() {
  ...
  if (this->sensor == lidar_mapping::SensorType::OUSTER) {
  ...
  } else if (this->sensor == lidar_mapping::SensorType::VELODYNE) {
  ...
  } else if (this->sensor == lidar_mapping::SensorType::HESAI) {
  ...
  } else if (this->sensor == lidar_mapping::SensorType::LIVOX) {
    point_time_cmp = [](const PointType& p1, const PointType& p2)
      { return p1.timestamp < p2.timestamp; };
    point_time_neq = [](boost::range::index_value<PointType&, long> p1,
                        boost::range::index_value<PointType&, long> p2)
...
void lidar_mapping::OdomNode::initializeInputTarget() {
...
void lidar_mapping::OdomNode::setInputSource() {
  this->gicp.setInputSource(this->current_scan);
  this->gicp.calculateSourceCovariances();
}

void lidar_mapping::OdomNode::initializeMapping() {
  ...
  this->lidar_mapping_initialized = true;
  std::cout << std::endl << " Mapping initialized!" << std::endl;

}

void lidar_mapping::OdomNode::callbackPointCloud(const sensor_msgs::msg::PointCloud2::SharedPtr pc) {
  ...
  // PLM Initialization procedures (IMU calib, gravity align)
  if (!this->lidar_mapping_initialized) {
    this->initializeMapping();
  }

  // Convert incoming scan into PLM format
  ...
  // Compute Metrics
  this->metrics_thread = std::thread( &lidar_mapping::OdomNode::computeMetrics, this );
  ...
  if (this->keyframes.size() == 0) {
    ...
    this->submap_future =
      std::async( std::launch::async, &lidar_mapping::OdomNode::buildKeyframesAndSubmap, this, this->state );
  ...
  this->publish_thread = std::thread( &lidar_mapping::OdomNode::publishToROS, this, published_cloud, this->T_corr );
  ...
  // Debug statements and publish custom PLM message
  this->debug_thread = std::thread( &lidar_mapping::OdomNode::debug, this );
...
void lidar_mapping::OdomNode::callbackImu(const sensor_msgs::msg::Imu::SharedPtr imu_raw) {
...
void lidar_mapping::OdomNode::getNextPose() {
...
bool lidar_mapping::OdomNode::imuMeasFromTimeRange(double start_time, double end_time,
...
lidar_mapping::OdomNode::integrateImu(double start_time, Eigen::Quaternionf q_init, Eigen::Vector3f p_init,
...
std::vector<Eigen::Matrix4f, Eigen::aligned_allocator<Eigen::Matrix4f>>
lidar_mapping::OdomNode::integrateImuInternal(Eigen::Quaternionf q_init, Eigen::Vector3f p_init, Eigen::Vector3f v_init,
...
void lidar_mapping::OdomNode::propagateGICP() {
...
void lidar_mapping::OdomNode::propagateState() {
...
void lidar_mapping::OdomNode::updateState() {
...
sensor_msgs::msg::Imu::SharedPtr lidar_mapping::OdomNode::transformImu(const sensor_msgs::msg::Imu::SharedPtr& imu_raw) {
...
void lidar_mapping::OdomNode::computeMetrics() {
  this->computeSpaciousness();
  this->computeDensity();
}

void lidar_mapping::OdomNode::computeSpaciousness() {
...
void lidar_mapping::OdomNode::computeDensity() {
...
void lidar_mapping::OdomNode::computeConvexHull() {
...
void lidar_mapping::OdomNode::computeConcaveHull() {
...
void lidar_mapping::OdomNode::updateKeyframes() {
...
void lidar_mapping::OdomNode::setAdaptiveParams() {
...
void lidar_mapping::OdomNode::pushSubmapIndices(std::vector<float> dists, int k, std::vector<int> frames) {
...
void lidar_mapping::OdomNode::buildSubmap(State vehicle_state) {
...
void lidar_mapping::OdomNode::buildKeyframesAndSubmap(State vehicle_state) {
  ...
  for (int i = this->num_processed_keyframes; i < this->keyframes.size(); i++) {
    ...
    this->publish_keyframe_thread = std::thread( &lidar_mapping::OdomNode::publishKeyframe, this, this->keyframes[i], this->keyframe_timestamps[i] );
...
void lidar_mapping::OdomNode::pauseSubmapBuildIfNeeded() {
...
void lidar_mapping::OdomNode::debug() {
